...
**Re-read** (2026-09-13, revision 5): 0 stumbles in 5 changed passages

- Fix: No wording changes. The physics review's number updates (a 25,800-year wobble, 5025 arcseconds per century of drift) read cleanly in their paragraphs, keep the 'So' link from the wobble period to the drift, and now make 5600 minus 5025 give the 575 the reader is told about.
- Fix: The Vulcan answer's added 'the speed of light' names a quantity the reader has met in the radar paragraph, so it adds no undefined term.
- Fix: Consistency: no learner-visible field still says 26,000 years or 5000 arcseconds per century.
- Fix: Validator: after this sign-off, no warnings remain (notes only).
