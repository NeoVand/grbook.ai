...
- [[twenty-of-256-slots]] (supporting): The split of the surviving count into Ricci and Weyl components as the dimension changes. *Sketch:* This concept adds a bar under the sieve, split into a Ricci segment and a Weyl segment that follow the dimension slider: six plus zero in three dimensions, ten plus ten in four, fifteen plus thirty-five in five.
