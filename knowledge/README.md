...
| 1. Chapter dossiers | read → verify each of 94 units (PDF renders for export losses); book profiles | in progress |
| 1b. Legacy inventory | 336 assets with reuse verdicts; `sources/legacy/overview.md` ranks what to carry forward | done |
| 2. Concept union | canonical concept registry across books, then concept notes with adversarial review | planned |
